...
insert l u .(suc h) x lx xu (node2 h y tlx txu) | x<=y .x .y pf with insert l (value y) h x lx pf tlx
...
insert l u .(suc h) x lx xu (node2 h y tlx txu) | y<=x .x .y pf with insert (value y) u h x pf xu txu
...
insert l u .(suc h) x lx xu (node3 h y z tly tyz tzu) | x<=y .x .y pf with insert l (value y) h x lx pf tly
...
insert l u .(suc h) x lx xu (node3 h y z tly tyz tzu) | y<=x .x .y pfxy | (x<=y .x .z pfxz) with insert (value y) (value z) h x pfxy pfxz tyz
...
insert l u .(suc h) x lx xu (node3 h y z tly tyz tzu) | y<=x .x .y pfxy | (y<=x .x .z pfxz) with insert (value z) u h x pfxz xu tzu
...
insert-ex x (23tree-ex height tree) with insert bottom top height x _ _ tree
